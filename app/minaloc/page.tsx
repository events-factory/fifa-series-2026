...
export default function MinalocPage() {
  ...
  const loadPage = async () => {
    ...
    try {
      ...
      setSelectedCategory({ id: NOC_CATEGORY_ID, name_english: 'Minaloc', name_french: 'Minaloc', fee: 'USD 0', early_payment_date: '', end_date: '' });
    } catch {
